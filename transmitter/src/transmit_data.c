...
void create_payload() {
  ...
  memcpy(&mfg_data[2], &local_data_container.q0, 4);
  memcpy(&mfg_data[6], &local_data_container.q1, 4);
  memcpy(&mfg_data[10],&local_data_container.q2, 4);
  memcpy(&mfg_data[14],&local_data_container.q3, 4);
  memcpy(&mfg_data[18],&local_data_container.tx_phase, 4);
}
...
int transmit() {
  ...
  printk("Broadcasting data: %.2f, %.2f, %.2f, %.2f | %.4f\n",
         local_data_container.q0, local_data_container.q1, local_data_container.q2,
         local_data_container.q3, local_data_container.tx_phase);
